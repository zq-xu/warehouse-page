import{v as d,y as e,aM as L,A as C,B as k,E as V,G as F,d as j,H as G,J as D,d1 as H,c as B,L as I,M as q,bT as J,q as n}from"./index-8a62db9b.js";import{u as K}from"./use-compitable-6ead11c5.js";import{g as N}from"./Space-4c54bcc7.js";function O(t,p="default",l=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const b=i[p];if(typeof b=="function")return b()}return l}const E="DESCRIPTION_ITEM_FLAG";function W(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[E]:!1}const Q=d([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
