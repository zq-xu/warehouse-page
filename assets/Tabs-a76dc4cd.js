import{d as q,r as _,c1 as ct,h as b,cf as bt,cg as J,ch as ft,j as pt,o as Se,bD as ut,c as K,J as vt,ag as ht,K as gt,af as mt,bJ as xt,ci as yt,e as n,g as i,a as R,i as A,ak as wt,m as Ct,p as Te,bY as ee,w as te,R as Rt,t as H,z as St,v as Tt,C as ve,V as he,cj as zt,ad as G,n as ae,s as j,c6 as Y,ab as $t,aO as Pt,T as _t,c0 as Wt}from"./index-5bf6305f.js";import{A as At}from"./Add-51e908eb.js";import{u as ge}from"./use-compitable-c6a6c985.js";import{u as Lt}from"./use-merged-state-ac77a2a7.js";import{c as Bt,a as me,o as Et}from"./cssr-a4590baa.js";const kt=me(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[me("&::-webkit-scrollbar",{width:0,height:0})]),jt=q({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=_(null);function r(l){!(l.currentTarget.offsetWidth<l.currentTarget.scrollWidth)||l.deltaY===0||(l.currentTarget.scrollLeft+=l.deltaY+l.deltaX,l.preventDefault())}const d=ct();return kt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Bt,ssr:d}),Object.assign({selfRef:e,handleWheel:r},{scrollTo(...l){var h;(h=e.value)===null||h===void 0||h.scrollTo(...l)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var It=/\s/;function Ot(e){for(var r=e.length;r--&&It.test(e.charAt(r)););return r}var Ft=/^\s+/;function Ht(e){return e&&e.slice(0,Ot(e)+1).replace(Ft,"")}var xe=0/0,Dt=/^[-+]0x[0-9a-f]+$/i,Mt=/^0b[01]+$/i,Nt=/^0o[0-7]+$/i,Vt=parseInt;function ye(e){if(typeof e=="number")return e;if(bt(e))return xe;if(J(e)){var r=typeof e.valueOf=="function"?e.valueOf():e;e=J(r)?r+"":r}if(typeof e!="string")return e===0?e:+e;e=Ht(e);var d=Mt.test(e);return d||Nt.test(e)?Vt(e.slice(2),d?2:8):Dt.test(e)?xe:+e}var Ut=function(){return ft.Date.now()};const re=Ut;var Xt="Expected a function",Gt=Math.max,Yt=Math.min;function Kt(e,r,d){var u,l,h,v,f,g,m=0,y=!1,w=!1,x=!0;if(typeof e!="function")throw new TypeError(Xt);r=ye(r)||0,J(d)&&(y=!!d.leading,w="maxWait"in d,h=w?Gt(ye(d.maxWait)||0,r):h,x="trailing"in d?!!d.trailing:x);function C(c){var z=u,I=l;return u=l=void 0,m=c,v=e.apply(I,z),v}function S(c){return m=c,f=setTimeout(L,r),y?C(c):v}function W(c){var z=c-g,I=c-m,F=r-z;return w?Yt(F,h-I):F}function $(c){var z=c-g,I=c-m;return g===void 0||z>=r||z<0||w&&I>=h}function L(){var c=re();if($(c))return T(c);f=setTimeout(L,W(c))}function T(c){return f=void 0,x&&u?C(c):(u=l=void 0,v)}function B(){f!==void 0&&clearTimeout(f),m=0,u=g=l=f=void 0}function k(){return f===void 0?v:T(re())}function p(){var c=re(),z=$(c);if(u=arguments,l=this,g=c,z){if(f===void 0)return S(g);if(w)return clearTimeout(f),f=setTimeout(L,r),C(g)}return f===void 0&&(f=setTimeout(L,r)),v}return p.cancel=B,p.flush=k,p}var Jt="Expected a function";function ne(e,r,d){var u=!0,l=!0;if(typeof e!="function")throw new TypeError(Jt);return J(d)&&(u="leading"in d?!!d.leading:u,l="trailing"in d?!!d.trailing:l),Kt(e,r,{leading:u,maxWait:r,trailing:l})}const se=pt("n-tabs"),ze={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},oa=q({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:ze,setup(e){const r=Se(se,null);return r||ut("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:r.paneStyleRef,class:r.paneClassRef,mergedClsPrefix:r.mergedClsPrefixRef}},render(){return b("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),qt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},yt(ze,["displayDirective"])),ie=q({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:qt,setup(e){const{mergedClsPrefixRef:r,valueRef:d,typeRef:u,closableRef:l,tabStyleRef:h,tabChangeIdRef:v,onBeforeLeaveRef:f,triggerRef:g,handleAdd:m,activateTab:y,handleClose:w}=Se(se);return{trigger:g,mergedClosable:K(()=>{if(e.internalAddable)return!1;const{closable:x}=e;return x===void 0?l.value:x}),style:h,clsPrefix:r,value:d,type:u,handleClose(x){x.stopPropagation(),!e.disabled&&w(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){m();return}const{name:x}=e,C=++v.id;if(x!==d.value){const{value:S}=f;S?Promise.resolve(S(e.name,d.value)).then(W=>{W&&v.id===C&&y(x)}):y(x)}}}},render(){const{internalAddable:e,clsPrefix:r,name:d,disabled:u,label:l,tab:h,value:v,mergedClosable:f,style:g,trigger:m,$slots:{default:y}}=this,w=l??h;return b("div",{class:`${r}-tabs-tab-wrapper`},this.internalLeftPadded?b("div",{class:`${r}-tabs-tab-pad`}):null,b("div",Object.assign({key:d,"data-name":d,"data-disabled":u?!0:void 0},vt({class:[`${r}-tabs-tab`,v===d&&`${r}-tabs-tab--active`,u&&`${r}-tabs-tab--disabled`,f&&`${r}-tabs-tab--closable`,e&&`${r}-tabs-tab--addable`],onClick:m==="click"?this.activateTab:void 0,onMouseenter:m==="hover"?this.activateTab:void 0,style:e?void 0:g},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),b("span",{class:`${r}-tabs-tab__label`},e?b(ht,null,b("div",{class:`${r}-tabs-tab__height-placeholder`}," "),b(gt,{clsPrefix:r},{default:()=>b(At,null)})):y?y():typeof w=="object"?w:mt(w??d)),f&&this.type==="card"?b(xt,{clsPrefix:r,class:`${r}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),Qt=n("tabs",`
